...
export default function BongBot({ onOpenChange }: BongBotProps) {
  ...
  return (
    <motion.div
      className="fixed right-4 z-[10001] select-none flex flex-col overflow-hidden"
      style={{
        ...
        <div className="p-4 bg-white/5 border-t border-white/10">
          <div className="flex gap-2 items-end">
            <textarea
              ...
              className="flex-1 bg-white/10 border border-white/10 rounded-xl px-4 py-2.5 text-[12px] text-white placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-blue-500/50 resize-none h-[42px]"
              onKeyDown={(e) => {
