...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'otp.subtitle': { bn: 'তোমার WhatsApp-এ একটা কোড পাঠিয়েছি', en: 'We sent a Reference number to your WhatsApp' },
  'otp.sentTo': { bn: 'পাঠানো হয়েছে:', en: 'Sent to:' },
  'otp.enterRef': { bn: 'কোড নম্বর লেখো', en: 'Enter Reference Number' },
  'otp.placeholder': { bn: '৬ সংখ্যার কোড', en: '6-digit number' },
  'otp.verify': { bn: 'ভেরিফাই করো ✓', en: 'Verify ✓' },
  'otp.verifying': { bn: 'চেক হচ্ছে...', en: 'Verifying...' },
  'otp.verified': { bn: '✅ ভেরিফায়েড!', en: '✅ Verified!' },
  'otp.resend': { bn: 'আবার পাঠাও', en: 'Resend code' },
  'otp.resendWait': { bn: 'Xসে পর আবার পাঠাতে পারবে', en: 'Resend in Xs' },
  'otp.skip': { bn: 'পরে করবো →', en: 'Skip for now →' },
  'otp.wrongCode': { bn: 'ভুল কোড! আবার চেষ্টা করো', en: 'Wrong Reference number! Try again' },
  'otp.expired': { bn: 'কোড মেয়াদ শেষ — আবার পাঠাও', en: 'Reference number expired — tap Resend' },
  'otp.sendFailed': { bn: 'পাঠানো যায়নি — আবার চেষ্টা করো', en: 'Could not send — please try again' },
  'otp.whatsappNote': { bn: '💡 WhatsApp-এ "Reference: XXXXXX" আসবে — সেই নম্বরটা লেখো', en: '💡 Look for a WhatsApp message with "Reference: XXXXXX" — enter that number' },

  // Dashboard — Phone verification (Phase B)
  'dash.phoneTitle': { bn: '📱 WhatsApp ভেরিফিকেশন', en: '📱 WhatsApp Verification' },
  'dash.phoneNone': { bn: 'WhatsApp নম্বর যোগ করো — অ্যাকাউন্ট ফেরত পেতে পারবে', en: 'Add WhatsApp number — recover your account anytime' },
  'dash.phoneUnverified': { bn: 'নম্বর ভেরিফাই করো', en: 'Verify your number' },
  'dash.phoneVerified': { bn: 'ভেরিফায়েড ✅', en: 'Verified ✅' },
  'dash.phoneAdd': { bn: 'নম্বর যোগ করো', en: 'Add number' },
  'dash.phoneVerifyBtn': { bn: 'ভেরিফাই করো', en: 'Verify now' },
  'dash.phoneSendRef': { bn: 'কোড পাঠাও', en: 'Send Reference Code' },
  'dash.phoneChange': { bn: 'নম্বর বদলাও', en: 'Change number' },
  'dash.phoneInputHint': { bn: '১০ সংখ্যার WhatsApp নম্বর', en: '10-digit WhatsApp number' },
  'dash.phoneInvalid': { bn: 'সঠিক নম্বর দাও (১০ সংখ্যা, ৬-৯ দিয়ে শুরু)', en: 'Enter valid number (10 digits, starts with 6-9)' },
  'dash.phoneDesc': { bn: 'WhatsApp-এ একটা কোড পাঠাবো', en: 'We\'ll send a Reference code via WhatsApp' },
  ...
  'pro.f3': { bn: 'AI troll shield — খারাপ message auto block', en: 'AI troll shield — auto-block abuse' },
