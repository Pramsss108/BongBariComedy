        ...
        <div className="flex justify-between items-center py-4 lg:py-6">
          ...
          <Link href="/" data-testid="logo-link">
            <div className="flex items-center space-x-1 cursor-pointer hover-logo-container group w-full">
              ...
              {/* Mobile Logo - Original Sizes with Better Position */}
              <div className="md:hidden flex flex-col justify-center pl-0.5 flex-1 mt-1">
              ...
              {/* Desktop Logo - Original Sizes with Better Position */}
              <div className="hidden md:flex flex-col justify-center pl-3 min-w-[280px] mt-2">
