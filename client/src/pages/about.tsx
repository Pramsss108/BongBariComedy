          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6" data-testid="about-content">
                <p className="text-lg text-gray-700 leading-relaxed" data-testid="about-paragraph-1">
                ...
                <p className="text-lg text-gray-700 leading-relaxed bangla-text" data-testid="about-paragraph-2">
                ...
                <p className="text-lg text-gray-700 leading-relaxed" data-testid="about-paragraph-3">
                ...
                <p className="text-lg text-gray-700 leading-relaxed bangla-text" data-testid="about-paragraph-4">
