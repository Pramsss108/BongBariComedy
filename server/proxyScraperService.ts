...
const MASTER_PROXY_SOURCES: OsintSource[] = [
  ...
  // ── TIER E: Residential-pool-adjacent & high-churn aggregators (added 2026-03) ─
  // These sources pull from ISP/ASN ranges with higher residential hit rate
  { url: 'https://raw.githubusercontent.com/zevtyardt/proxy-list/main/all.txt', proto: 'http',
    backup: ['https://raw.githubusercontent.com/zevtyardt/proxy-list/main/http.txt'] },
  { url: 'https://raw.githubusercontent.com/zevtyardt/proxy-list/main/socks5.txt', proto: 'socks5' },
  { url: 'https://raw.githubusercontent.com/prxchk/proxy-list/main/all.txt', proto: 'http',
    backup: ['https://raw.githubusercontent.com/prxchk/proxy-list/main/socks5.txt'] },
  { url: 'https://raw.githubusercontent.com/almroot/proxylist/master/list.txt', proto: 'http' },
  { url: 'https://raw.githubusercontent.com/fate0/proxylist/master/proxy.list', proto: 'http' },
  { url: 'https://raw.githubusercontent.com/ErcinDedeoglu/proxies/main/proxies/http.txt', proto: 'http',
    backup: ['https://raw.githubusercontent.com/ErcinDedeoglu/proxies/main/proxies/socks5.txt'] },
  ...
  { url: 'https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/all/data.txt', proto: 'http',
    backup: ['https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/protocols/socks5/data.txt'] },
  { url: 'https://openproxy.space/list/http', proto: 'http',
    backup: ['https://openproxy.space/list/socks5'] },
  { url: 'https://openproxy.space/list/socks5', proto: 'socks5' },
  { url: 'https://api.proxyscrape.com/v3/free-proxy-list/get?request=displayproxies&proxy_type=http&timeout=10000', proto: 'http' },
  { url: 'https://api.proxyscrape.com/v3/free-proxy-list/get?request=displayproxies&proxy_type=socks5&timeout=10000', proto: 'socks5' },
  ...
  { url: 'https://raw.githubusercontent.com/B4RC0DE-TM/proxy-list/main/HTTP.txt', proto: 'http',
    backup: ['https://raw.githubusercontent.com/B4RC0DE-TM/proxy-list/main/SOCKS5.txt'] },
  { url: 'https://raw.githubusercontent.com/B4RC0DE-TM/proxy-list/main/SOCKS5.txt', proto: 'socks5' },
  { url: 'https://raw.githubusercontent.com/sunny9577/proxy-scraper/master/proxies.txt', proto: 'http' },
  { url: 'https://raw.githubusercontent.com/UptimerBot/proxy-list/main/proxies/http.txt', proto: 'http' },
  { url: 'https://raw.githubusercontent.com/UptimerBot/proxy-list/main/proxies/socks5.txt', proto: 'socks5' },
];
